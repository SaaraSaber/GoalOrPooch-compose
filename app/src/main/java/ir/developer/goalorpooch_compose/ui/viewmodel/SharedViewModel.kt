...
class SharedViewModel @Inject constructor(
    ...
    fun getItemsGameGuide(): List<GameGuideModel> {
        val s= listOf(
            GameGuideModel(title = "کارت\u200Cهای بازی گل یا پوچ", description = "در هر دست بازی علاوه بر اینکه هر گروه اجازه دارد سه بار دستور خالی بازی بدهد می\u200Cتواند از یک کارت هم استفاده کند. کارت\u200Cهایی حاوی برخی دستورها که به تیم حدس زننده کمک می\u200Cکند تا راحت\u200Cتر گل را پیدا کند؛\n" +
                    ...
                    GameGuideModel(title = "چینش کارت های بازی گل یا پوچ", description = "هر تیم 9 کارت مقابل خود دارد که باید 5 تا از این کارت ها را به صورت شانسی انتخاب کند ولی توجه کنید :\n" +
                    ...
                    GameGuideModel(title = "شاه گل بازی گل یا پوچ", description = "بازی در مجموع 9 امتیازی می باشد و تیمی که به امتیاز 8 برسد امتیاز آخر اسمش شاه گل است و اگر بتواند شاه گل را درست حدس بزند تیم بازنده 3 امتیاز از دست می دهد.\n" +
                    ...
                    GameGuideModel(title = "روش های امتیاز دهی بازی گل یا پوچ", description = "در مرحله مقدماتی بازی ها 9 امتیازی هست و هر گروه 3 تیم دارد که 2 تیم صعود می کنند.\n" +
                    ...
                    GameGuideModel(title = "مکعب امتیاز بازی گل یا پوچ", description = "هر تیم می تواند امتیاز آن دست را به دو با بیشتر افزایش دهد.تیم صاحب گل اگر مکعب رو بپذیره بازی ادامه پیدا می کنه و اگر گل رو بگیرن دو امتیاز بالا می روند.اما اگر نپذیره تیم گل گیر بدون کسب امتیاز صاحب گل می شود.اگر گل را نگیرد تیم دارنده گل به عدد تاس امتیاز بالا می رود.\n" +
                    ...
                    GameGuideModel(title = "نکات مهم بازی گل یا پوچ", description = "با شیر یا خط صاحب گل اول انتخاب می شود.سپس لیدر تیم به تنهایی بازی می کند و یک نفر از تیم حریف حدس می زند.اگر درست باشد گل را می گیرد.\n" +
        ...
        Log.i("getItemsGameGuide", "getItemsGameGuide: $s")
        return s
    }
